...
def main():
    ...
    submenu_editorials = ConsoleMenu("Editorials", "Read editorials and articles")
    ...
    command_item_eds_hbl = CommandItem("Hindu Business Line", "node index eds hbl")
    command_item_eds_guardian = CommandItem("Guardian", "node index eds guardian")
    command_item_eds_projsyn = CommandItem("Project Syndicate", "node index projsyn all")
    ...
    menu_submenu_editorials = SubmenuItem("Editorials", submenu=submenu_editorials)
    ...
    command_item_sports_epl = CommandItem("English Premier League", "node index sports epl")
    ...
    submenu_mgmt = ConsoleMenu("Management/Startups", "Leadership in a gist...")
    command_item_mgmt_hbr = CommandItem("Harvard Business Review", "node index hbr latest")
    ...
    menu_submenu_mgmt = SubmenuItem("Management/Startups", submenu=submenu_mgmt)
    menu_submenu_sports.set_menu(menu)
